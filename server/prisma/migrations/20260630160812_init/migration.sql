-- CreateEnum
CREATE TYPE "verification_purpose" AS ENUM ('EMAIL_VERIFICATION', 'EMAIL_CHANGE');
...
-- CreateEnum
CREATE TYPE "audit_action" AS ENUM ('USER_REGISTERED', 'USER_LOGIN', 'USER_LOGOUT', 'LOGIN_FAILED', 'PASSWORD_RESET_REQUESTED', 'PASSWORD_RESET_COMPLETED', 'PASSWORD_CHANGED', 'EMAIL_VERIFIED', 'EMAIL_CHANGE_REQUESTED', 'EMAIL_CHANGED', 'PROFILE_UPDATED', 'ACCOUNT_DELETED', 'SESSION_REVOKED', 'ALL_SESSIONS_REVOKED', 'REFRESH_TOKEN_REUSE_DETECTED', 'TWO_FACTOR_ENABLED', 'TWO_FACTOR_DISABLED', 'TWO_FACTOR_CHALLENGE_SUCCEEDED', 'TWO_FACTOR_CHALLENGE_FAILED', 'BACKUP_CODES_REGENERATED', 'OAUTH_LOGIN', 'OAUTH_ACCOUNT_LINKED', 'OAUTH_ACCOUNT_UNLINKED', 'ROLE_CREATED', 'ROLE_UPDATED', 'ROLE_DELETED', 'ROLE_PERMISSIONS_UPDATED', 'USER_ROLES_UPDATED', 'ORG_CREATED', 'ORG_UPDATED', 'ORG_DELETED', 'ORG_MEMBER_INVITED', 'ORG_MEMBER_JOINED', 'ORG_MEMBER_REMOVED', 'ORG_MEMBER_ROLE_CHANGED', 'ORG_MEMBER_LEFT', 'ORG_OWNERSHIP_TRANSFERRED', 'TEAM_CREATED', 'TEAM_DELETED', 'TEAM_MEMBER_ADDED', 'TEAM_MEMBER_REMOVED');
